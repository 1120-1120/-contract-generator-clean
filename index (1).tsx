...
買主：${form.buyer}
  ...
  return (
    <div style={{ maxWidth: "600px", margin: "0 auto", padding: "20px" }}>
      ...
      <br />
      <input
        placeholder="売買代金（例：1000000）"
        value={form.price}
        onChange={(e) => setForm({ ...form, price: e.target.value })}
      />
      <br />
      <input
        placeholder="引渡し予定日（例：令和7年4月30日）"
        value={form.date}
      ...
      <label>
        <input
          type="checkbox"
          checked={form.addressUpdate}
          onChange={() =>
            setForm({ ...form, addressUpdate: !form.addressUpdate })
          }
        />
        住所変更登記（費用買主）
      </label>
      ...
      <label>
        <input
          type="checkbox"
          checked={form.fumei}
          onChange={() => setForm({ ...form, fumei: !form.fumei })}
        />
        境界非明示
      </label>
      <br />
      <label>
        <input
          type="checkbox"
          checked={form.zanchi}
          onChange={() => setForm({ ...form, zanchi: !form.zanchi })}
        />
        残置物は買主撤去
      </label>
      <br />
